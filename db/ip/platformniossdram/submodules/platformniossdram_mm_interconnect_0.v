...
module platformniossdram_mm_interconnect_0 (
	...
	wire   [26:0] hex_s1_agent_m0_address;                                                            // hex_s1_agent:m0_address -> hex_s1_translator:uav_address
	...
	wire  [105:0] hex_s1_agent_rf_source_data;                                                        // hex_s1_agent:rf_source_data -> hex_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] hex_s1_agent_rsp_fifo_out_data;                                                     // hex_s1_agent_rsp_fifo:out_data -> hex_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> hex_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // hex_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [12:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> hex_s1_agent:cp_channel
	...
	wire   [26:0] keys_s1_agent_m0_address;                                                           // keys_s1_agent:m0_address -> keys_s1_translator:uav_address
	...
	wire  [104:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> keys_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // keys_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [12:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> keys_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_009_src_data;                                                               // cmd_mux_009:src_data -> timer_1_s1_agent:cp_data
	wire          cmd_mux_009_src_ready;                                                              // timer_1_s1_agent:cp_ready -> cmd_mux_009:src_ready
	wire   [12:0] cmd_mux_009_src_channel;                                                            // cmd_mux_009:src_channel -> timer_1_s1_agent:cp_channel
	...
	wire   [26:0] control_s1_agent_m0_address;                                                        // control_s1_agent:m0_address -> control_s1_translator:uav_address
	...
	wire  [105:0] control_s1_agent_rf_source_data;                                                    // control_s1_agent:rf_source_data -> control_s1_agent_rsp_fifo:in_data
	...
	wire  [105:0] control_s1_agent_rsp_fifo_out_data;                                                 // control_s1_agent_rsp_fifo:out_data -> control_s1_agent:rf_sink_data
	...
	wire  [104:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> control_s1_agent:cp_data
	...
	wire  [104:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> timer_2_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // timer_2_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> timer_2_s1_agent:cp_channel
	...
	wire  [104:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> switches_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // switches_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> switches_s1_agent:cp_channel
	...
	wire  [104:0] hex_s1_agent_rp_data;                                                               // hex_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [104:0] keys_s1_agent_rp_data;                                                              // keys_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [104:0] timer_1_s1_agent_rp_data;                                                           // timer_1_s1_agent:rp_data -> router_011:sink_data
	...
	wire  [104:0] control_s1_agent_rp_data;                                                           // control_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [104:0] timer_2_s1_agent_rp_data;                                                           // timer_2_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [104:0] switches_s1_agent_rp_data;                                                          // switches_s1_agent:rp_data -> router_014:sink_data
	...
	platformniossdram_mm_interconnect_0_router_002 router_003 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_011 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_012 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_013 (
	...
	platformniossdram_mm_interconnect_0_router_002 router_014 (
	...
	platformniossdram_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_cmd_mux cmd_mux_011 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_cmd_mux cmd_mux_012 (
		.clk                 (pll_0_outclk0_clk),                              //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_009 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_010 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_011 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_rsp_demux rsp_demux_012 (
		.clk                (pll_0_outclk0_clk),                              //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	platformniossdram_mm_interconnect_0_avalon_st_adapter_004 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
